...
abstract class AppLocalizations {
  ...
  /// No description provided for @modernTurkmen.
  ///
  /// In en, this message translates to:
  /// **'Modern Turkmen'**
  String get modernTurkmen;

  /// No description provided for @prevTutorial.
  ///
  /// In en, this message translates to:
  /// **'Prev'**
  String get prevTutorial;
  ...
  /// No description provided for @wrongTry.
  ///
  /// In en, this message translates to:
  /// **'Wrong! Try again'**
  String get wrongTry;
  ...
  /// No description provided for @correctAt.
  ///
  /// In en, this message translates to:
  /// **'{percent}% correct'**
